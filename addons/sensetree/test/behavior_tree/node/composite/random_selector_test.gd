...
var random_selector_composite_node: SenseTreeRandomSelectorComposite
...
func before_test() -> void:
	...
	random_selector_composite_node = auto_free(random_selector_composite_script.new())
	...
	sensetree.add_child(random_selector_composite_node)
...
func test_tick_randomizes_children() -> void:
	...
	random_selector_composite_node.add_child(child_mock_a)
	random_selector_composite_node.add_child(child_mock_b)
	random_selector_composite_node.add_child(child_mock_c)
	random_selector_composite_node.add_child(child_mock_d)
	random_selector_composite_node.add_child(child_mock_e)

	# When
	sensetree.tick(actor, blackboard)

	# Then
	var result_a = random_selector_composite_node.get_child(1)
	var result_b = random_selector_composite_node.get_child(2)
	var result_c = random_selector_composite_node.get_child(0)
	var result_d = random_selector_composite_node.get_child(3)
	var result_e = random_selector_composite_node.get_child(4)
...
func test_get_sensenode_class() -> void:
	...
	# When
	var result_class_name = random_selector_composite_node.get_sensenode_class()
