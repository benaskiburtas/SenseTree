...
var selector_composite_node: SenseTreeSelectorComposite
...
func before_test() -> void:
	...
	selector_composite_node = auto_free(selector_composite_script.new())
	...
	sensetree.add_child(selector_composite_node)
...
func test_parameterized_child_index(
	...
	selector_composite_node.add_child(child_mock_a)
	selector_composite_node.add_child(child_mock_b)
	selector_composite_node.add_child(child_mock_c)
...
func test_get_sensenode_class() -> void:
	...
	# When
	var result_class_name = selector_composite_node.get_sensenode_class()
